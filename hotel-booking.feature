...
The Hotel booking system is aimed at our sales team so that they can make room bookings for our guest.
...
Scenario: Editing an existing booking
    ...
    Then the booking should ammanded
